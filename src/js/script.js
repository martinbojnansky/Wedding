(function($) {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2019/05/18 14:00', function(event) {
            var $this = $(this).html(event.strftime(''
            + '<div class="box"><div>%D</div> <span>Dní</span> </div>'
            + '<div class="box"><div>%H</div> <span>Hodín</span> </div>'
            + '<div class="box"><div>%M</div> <span>Minút</span> </div>'
            + '<div class="box"><div>%S</div> <span>Sekúnd</span> </div>'));
        });
    }
